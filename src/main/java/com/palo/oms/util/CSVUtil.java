...
public class CSVUtil {
    ...
    private static OrderInfo validateCSVRecordAndConvertToOrder(CSVRecord csvRecord){
        ...
        try {
            ...
            orderInfo.setOrderDate(LocalDate.parse(orderDate, DateTimeFormatter.ofPattern("M/d/yyyy")));
            orderInfo.setShipDate(LocalDate.parse(shipDate, DateTimeFormatter.ofPattern("M/d/yyyy")));
